        ...
        <div class="wrapper" id="app">
            <div class="card-form">
                                ...
                                <div class="card-item__content">
                                    <label for="cardName" class="card-item__info" ref="cardName">
                                        ...
                                        <transition name="slide-fade-up">
                                            ...
                                            <div class="card-item__name" v-else key="2">NOMBRE APELLIDO</div>
                                        </transition>
                                    </label>
                                    <div class="card-item__date" ref="cardDate">
                                        <label for="cardMonth" class="card-item__dateTitle">VENCE</label>
                ...
                <div class="card-form__inner">
                    ...
                    <div class="card-input">
                        <label for="cardName" class="card-input__label">Propietario</label>
                    ...
                    <div class="card-input">
                        <label for="cardName" type="number" class="card-input__label">Cedula de identidad</label>
                        <input type="text" id="ci" class="card-input__input" v-model="ci" >
                    </div>

                    <div class="card-form__row">
                        <div class="card-form__col">
                            <div class="card-form__group">
                                <label for="cardMonth" class="card-input__label">Fecha de vencimiento</label>
                        ...
                        <input type="hidden" v-model="paymentMethod" id="paymentMethodId" />
                    ...
                    <v-btn color="primary" :loading="loading" class="card-form__button" @click="sendData()">
                        PAGAR
                    </v-btn>
                </div>
            </div>
        </div>
        <v-snackbar v-model="error" color="warning" :timeout="5000">
            <v-icon>warning</v-icon>Rellene todos los campos!
        </v-snackbar>
...
<script>
    ...
    export default {
        ...
        mounted() {
            setTimeout(() => {
                window.Mercadopago.setPublishableKey('APP_USR-5d6ea979-4790-47b1-8155-c3d48c89bc61');                
            }, 3000);
        ...
        methods: {
            sendData() {
                if(!this.cardNumber || !this.cardCvv || !this.cardName){
                    this.error = true 
                    return
                }
                this.loading = true
                this.getToken({
                    ...
                    cardExpirationYear: this.cardYear,
            ...
            getToken({
                ...
                window.Mercadopago.createToken($form, (status, response) => {
                    ...
                    if (status !== 200 && status !== 201) return this.error = true
                    this.swalPayment(response);
                });
            },
            async swalPayment(response) {
                ...
                try {
                    var bin = this.cardNumber.split(" ").join("").substr(0, 6)
                    var vm = this
                    console.log(bin)
            ...
            async sendPaymentData({
                ...
                try {
                    return this.$axios.post(this.$axios.defaults.baseURL + `/productos/impulsar/${this.$route.params.id_producto}`, {
                            token,
                            paymentMethod,
                            installments,
                        }).then(res => res)
